...
void Mpg123Decoder::run()
{
    ...
    mpg123_format(mpg123Handle, 44100, MPG123_STEREO, MPG123_ENC_SIGNED_16);

    // Bugfix 1747522
    // These are all valid formats, but seems like QAudioAutput (or some Ubuntu component) can't handle them correctly
    // TODO: create an output plugin with libout123 and test these formats with that
